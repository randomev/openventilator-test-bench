...
namespace TA400
{
    public partial class Form1 : Form
    {
        ...
        private void send()
        {
            ...
            serialPort1.ReceivedBytesThreshold = 46*2; // 2 datapackets 
        ...
        private void serialPort1_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                bytesread = serialPort1.Read(bytes, bytesread, serialPort1.BytesToRead);
                ...
                { 
                    if (bytes[bstart] == 0xAA && bytes[bstart+1] == 0xBB)
                    {
                        ...
                        { // existing datapacket
                            ...
                            int tempc = last_datapacket[21] * 256 + last_datapacket[20];

                            int b7 = last_datapacket[7] - 0x80;
                            int flow = last_datapacket[19] * 256 + last_datapacket[18];
